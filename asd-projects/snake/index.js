...
function checkForNewDirection(event) {
  ...
  perpendicular to the current direction --> did that
  */
...
function hasHitWall() {
  ...
  */
  ...
  if(snake.head.column > COLUMNS || snake.head.column < 0 || snake.head.row < 0 || snake.head.row > ROWS){
    return  true
  }
...
function handleAppleCollision() {
  ...
  */
  ...
  if (snake.tail.direction === "right"){
   ...
   if (snake.tail.direction === "top"){
    column--
  }  if (snake.tail.direction === "bottom"){
    column++
  }
